...
if(!empty($_GET['id'])) 
    ...
    $statement = $bdd->prepare("SELECT id, nom, recette, tpscuisson, puissancecuisson, tempsprepa ,data_img FROM recettes  WHERE id = ?");
			...
			<div class="row">
				<div class="col-sm-6">
					...
					<form>
                        ...
                        <div class="form-group">
							<label>Puissance de Cuisson:</label>
							<?php echo '  '.$item['puissancecuisson'];?>
							<label> °C</label>
						</div>
					</form>
					<br>
